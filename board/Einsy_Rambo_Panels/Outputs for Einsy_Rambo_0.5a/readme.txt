Readme File for Printed Circuit Board 'Einsy_Rambo_0.4a'
...
5. We wish to have an orange soldermask with a black silkscreen on top.  However,
  we want the soldermask INVERTED (negative).  The end result should be a black 
  surface with orange silkscreen legend showing from beneath.
...
Stackup                       Einsy Rambo_Stackup.xls
...
6 pcs = 2 panels / 1 days
6 pcs = 2 panels / 2 days
6 pcs = 2 panels / 3 days
